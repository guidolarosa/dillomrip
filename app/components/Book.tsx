...
const Book = (props: any) => {
  return (
    <div
      className="book h-[480px] min-w-[420px] w-[100%] md:w-[820px] md:h-[720px]"
    >
      <div className="w-full h-full absolute bottom-32 md:bottom-[240px] left-[0] scale-[0.9]">
      ...
      <div className="w-full h-full relative top-[-120px] md:top-[-160px]">
        <Image
          fill
          src="/book.png"
          alt="Grave"
